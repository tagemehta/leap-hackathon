    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section(header: Text(searchMode == .uberFinder ? "Vehicle Description" : "What are you looking for?")) {
                    ...
                    TextField(
                        searchMode == .uberFinder ? "Describe your ride (e.g., 'white Toyota Camry with license plate ABC123')" : "Describe it in detail (e.g., 'silver laptop with a white and green laptop sticker')",
                        text: $description,
                        axis: .vertical
                    )
