...
struct CameraPreviewView: UIViewControllerRepresentable {
  ...
  class Coordinator: NSObject {
    ...
    func updatePreviewFrame() {
      guard let view = viewController?.view, let previewLayer = parent.videoCapture.previewLayer
      else { return }
  ...
  init(
    isRunning: Binding<Bool> = .constant(false), delegate: VideoCaptureDelegate? = nil
  ) {
...
#Preview {
  struct Preview: View {
    ...
    var body: some View {
      CameraPreviewWrapper(isRunning: $running)
    }
  }
